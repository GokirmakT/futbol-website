...
const OverGoals = ({ goalStats, selectedLeague, isMobile, teamLogos, football, playedMatches, getBgColor }) => {  
  ...
  const [orderBy, setOrderBy] = useState("over35Rate");
            ...
            <Table size="small" stickyHeader sx={{borderRadius: 0}}>
              <TableHead sx={{ "& .MuiTableCell-root": { backgroundColor: "#1d1d1d" } }}>
                <TableRow>
                  ...
                  <SortHeader align="center" field="homeOver35Rate" abc="İç Saha"></SortHeader>
                  <SortHeader align="center" field="awayOver35Rate" abc="Dış Saha"></SortHeader>
                </TableRow>
              </TableHead>
