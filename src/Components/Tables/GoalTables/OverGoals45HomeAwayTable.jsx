...
const OverGoals = ({ goalStats, selectedLeague, isMobile, teamLogos, football, playedMatches, getBgColor }) => {  
  ...
  const [orderBy, setOrderBy] = useState("over45Rate");
            ...
            <Table size="small" stickyHeader sx={{borderRadius: 0}}>
              <TableHead sx={{ "& .MuiTableCell-root": { backgroundColor: "#1d1d1d" } }}>
                <TableRow>
                  ...
                  <SortHeader align="center" field="homeOver45Rate" abc="İç Saha"></SortHeader>
                  <SortHeader align="center" field="awayOver45Rate" abc="Dış Saha"></SortHeader>
                </TableRow>
              </TableHead>
