            ...
            <Table size="small" stickyHeader sx={{borderRadius: 0}}>
              <TableHead sx={{ "& .MuiTableCell-root": { backgroundColor: "#1d1d1d" } }}>
                <TableRow>
                  ...
                  <SortHeader align="center" field="homeOver25Rate" abc="İç Saha"></SortHeader>
                  <SortHeader align="center" field="awayOver25Rate" abc="Dış Saha"></SortHeader>
                </TableRow>
              </TableHead>
              ...
              <TableBody>
                {sortedRows.map(row => (
                  <TableRow key={row.team} sx={{ "&:hover": { backgroundColor: "#2c2c2c" } }}>
                    ...
                    <TableCell align="center" sx={{color: "#000000ff", fontWeight: "bold", backgroundColor: getBgColor(row.homeOver25Rate), pr: isMobile ? 0 : 2, pl: isMobile ? 0 : 2}}>{row.homeOver25Rate.toFixed(0)}%</TableCell>
                    <TableCell align="center" sx={{color: "#000000ff", fontWeight: "bold", backgroundColor: getBgColor(row.awayOver25Rate), pr: isMobile ? 0 : 2, pl: isMobile ? 0 : 2}}>{row.awayOver25Rate.toFixed(0)}%</TableCell>
