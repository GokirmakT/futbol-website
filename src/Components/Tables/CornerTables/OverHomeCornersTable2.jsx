...
const OverCorners = ({ cornerStats, selectedLeague, isMobile, teamLogos, corner, playedMatches, getBgColor }) => {  
    ...
    const [orderBy, setOrderBy] = useState("team65Rate");
                    ...
                    <Table size="small" stickyHeader sx={{borderRadius: 0}}>
                      <TableHead sx={{ "& .MuiTableCell-root": { backgroundColor: "#1d1d1d" } }}>
                        <TableRow>
                          ...
                          <SortHeader align="center" field="team65Rate" abc="6.5 Üst"></SortHeader>
                          <SortHeader align="center" field="team75Rate" abc="7.5 Üst"></SortHeader>
                          <SortHeader align="center" field="team85Rate" abc="8.5 Üst"></SortHeader>
