...
const OverCorners = ({ cornerStats, selectedLeague, isMobile, teamLogos, corner, playedMatches, getBgColor }) => {  
    ...
    const [orderBy, setOrderBy] = useState("team35Rate");
                    ...
                    <Table size="small" stickyHeader sx={{borderRadius: 0}}>
                      <TableHead sx={{ "& .MuiTableCell-root": { backgroundColor: "#1d1d1d" } }}>
                        <TableRow>
                          ...
                          <SortHeader align="center" field="team35Rate" abc="3.5 Üst"></SortHeader>
                          <SortHeader align="center" field="team45Rate" abc="4.5 Üst"></SortHeader>
                          <SortHeader align="center" field="team55Rate" abc="5.5 Üst"></SortHeader>
